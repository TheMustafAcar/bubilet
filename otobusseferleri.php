...
<body>
    ...
    <div>
        ...
        <h1 style="font-size: 20px; text-align:center; ">Eskişehir Otogarı</h1>
        </div>
        ...
        <h1 style="font-size: 20px; text-align:center; ">Bursa Otogarı</h1>
        </div>
        <i  class="fa-solid fa-right-long" style="color: #000000; margin-top:20px; margin-left:50px;"></i>
        <div style="margin-left: 50px;">
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                foreach($row as $sefer) {
                  ...
                  "<div style='width: 80%; height:120px; background-color:  #F8F8F8F8; box-shadow: 3px 3px 5px rgba(0, 0, 0, 0.3); border-radius: 10px; margin-top: 50px; display: flex; '>
                   <div>
                      <a href='$sefer[baglanti]' target='_blank'><img style='width: 120px; padding: 10px;' src='imagefirma/$sefer[resim_adi]' alt=''></a>
                  </div>
                  <div> 
                  ...
                  <div>
                      <h1 style='font-size: 20px; margin-left: 180px; margin-top: 20px;'><i class='fa-solid fa-couch' style='color: #000000;'></i>  $sefer[koltuk_tipi]</h1>
                  </div>
