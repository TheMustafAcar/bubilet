...
<body>
    ...
    <nav class="navbar2" style="display: flex; margin-left: 100px;">
      ...
      <a href="index.php"></a><button type="button" class="btn btn-danger"><i class="fa-solid fa-bus" style="color: #ffffff;"></i>Otobüs</button></a>
      <a href="indexucak.php"><button type="button" class="btn btn-outline-danger" style="margin-left: 30px;"><i class="fa-solid fa-plane" style="color: #ff0000;"></i>Uçak</button></a>
    ...
    <div style="background-image:url(img/ortabackground.jpg);background-size: cover; background-position: center; width: 100%; height: 500px; display: flex; justify-content:space-around;align-items: center;"
      class="banner">   
        <!-- banner left content -->
        <form require method="POST" id="myForm" action="" style="background-color: white; width: 34%; height: 400px; border-radius: 10px; " class="leftcontent"> 
          <div style="margin-top: 40px; position: relative;width:100%; height: 33%; background-color: #ffffff; display: flex; flex-direction: column; justify-content: center; align-items: center;">
            ...
            <span style="width: 100%; display:flex;flex-direction: row; align-items: center; justify-content: center;"> <span style="position: absolute; left: 10px;"><i  class="fa-solid fa-location-dot" style="scale: 1.2; color: #8f8f8f;"></i></span><input require name="kalkis" style="outline: none; position: absolute; left: 30px; bottom: 60px; width: 80%; border: none; padding: 10px;" type="text" id="inputField" list="sehirler2" placeholder="Şehir seçin"></span>
    ...
    <div style="background-color: rgba(255, 255, 255,); width: 1200px; height: 400px;  display: flex; ">
        ...
        <div class="card" style="width: 18rem; margin-left: 8px;">
            <div style="justify-content: center; display: flex; height: 50%;"><img src="img/7.24mh.png" style="width: 180px; height: 140px; margin-top: 25px;" class="card-img-top" alt="..."></div>
          ...
          <div class="card" style="width: 18rem; margin-left: 10px;">
            ...
            <div class="card-body" style="height: 50%;">
              <p class="card-text"><h1 style="font-size: 16px; text-align:center;">Her Bütçeye Uygun</h1>BUBilet size tüm firmaların otobüs biletlerini karşılaştırma imkanı sunar. Bu sayede bütçenize uygun otobüs biletini rahatlıkla bulabilir ve satın alabilirsiniz.</p>
            </div>
          </div>
          <div class="card" style="width: 18rem; margin-left: 10px;">
            <div style="justify-content: center; display: flex; height: 50%;"><img src="img/otobusf.png" style="width: 200px; height: 150px; margin-top: 21px;" class="card-img-top" alt="..."></div>
            <div class="card-body" style="height: 50%;">
              <p class="card-text"><h1 style="font-size: 16px; text-align:center;">En Seçkin Firmalar</h1>BUBilet olarak en seçkin otobüs firmalarını sizler için bir araya topladık. Tüm firmaların otobüs biletlerini karşılaştırabilir, uygun otobüs biletini bulabilirsiniz.</p>
            </div>
          </div>
    </div>
    </div>
